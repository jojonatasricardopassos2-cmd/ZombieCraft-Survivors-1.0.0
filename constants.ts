...
export const RECIPES: CraftingRecipe[] = [
  ...
  // --- CONCRETE ---
  { result: { id: BlockType.CONCRETE_RED, count: 1, type: 1 /* ITEM_TYPE.BLOCK */ }, ingredients: [{ id: BlockType.WET_SAND, count: 1 }, { id: BlockType.FLOWER_RED, count: 1 }], station: BlockType.CRAFTING_TABLE, category: 'DECOR' },
  { result: { id: BlockType.CONCRETE_YELLOW, count: 1, type: 1 }, ingredients: [{ id: BlockType.WET_SAND, count: 1 }, { id: BlockType.FLOWER_YELLOW, count: 1 }], station: BlockType.CRAFTING_TABLE, category: 'DECOR' },
  { result: { id: BlockType.CONCRETE_GREEN, count: 1, type: 1 }, ingredients: [{ id: BlockType.WET_SAND, count: 1 }, { id: BlockType.FLOWER_GREEN, count: 1 }], station: BlockType.CRAFTING_TABLE, category: 'DECOR' },
  { result: { id: BlockType.CONCRETE_BLUE, count: 1, type: 1 }, ingredients: [{ id: BlockType.WET_SAND, count: 1 }, { id: BlockType.FLOWER_BLUE, count: 1 }], station: BlockType.CRAFTING_TABLE, category: 'DECOR' },
  { result: { id: BlockType.CONCRETE_PURPLE, count: 1, type: 1 }, ingredients: [{ id: BlockType.WET_SAND, count: 1 }, { id: BlockType.FLOWER_PURPLE, count: 1 }], station: BlockType.CRAFTING_TABLE, category: 'DECOR' },
